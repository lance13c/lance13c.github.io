...
// Lights
var light = new THREE.HemisphereLight(0x0000ff, 0x00ff00, 10);
scene.add(light);

var pointLight = new THREE.PointLight(0x000000, 0.1, 1000);
...
},{"../abstracts":1,"./orbit":4}],3:[function(require,module,exports){
'use strict';
...
},{"./components/background":2,"./components/birds":3}]},{},[5])
